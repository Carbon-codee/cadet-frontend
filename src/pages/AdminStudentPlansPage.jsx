    ...
    return (
        <div style={pageStyle}>
            <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
                <h1 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '2rem', display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <FaChartLine /> Öğrenci Çalışma Planları
                    <span style={{ fontSize: '1rem', backgroundColor: '#e2e8f0', padding: '0.2rem 0.8rem', borderRadius: '20px', marginLeft: 'auto' }}>
                        Toplam: {plans.length}
                    </span>
                </h1>
                                    ...
                                    <div style={{ flex: 1 }}>
                                        ...
                                        <div style={{ display: 'flex', gap: '20px', color: '#64748b', fontSize: '0.9rem' }}>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                                                <FaBuilding /> {plan.targetCompany?.name || 'Şirket Yok'}
                                            </div>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                                                <FaCalendar /> {new Date(plan.createdAt).toLocaleDateString('tr-TR')}
                                            </div>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '5px', color: plan.isActive ? '#16a34a' : '#94a3b8' }}>
